  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=pgw"><i class="glyphicon glyphicon-user"></i>
        <span>Pegawai</span></a></li>
        <li><a href="index.php?hal=spl"><i class="glyphicon glyphicon-inbox"></i>
        <span>Supplier</span></a></li>
        <li><a href="index.php?hal=brg"><i class="glyphicon glyphicon-bed"></i>
