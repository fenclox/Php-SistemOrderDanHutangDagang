  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=spl"><i class="glyphicon glyphicon-inbox"></i> <span>Supplier</span></a></li>
        <!-- Menu lainnya -->
        <li class="header">MENU LAINNYA</li>
        <li class="treeview">
          <a href="#">
            <i class="glyphicon glyphicon-shopping-cart"></i> <span>PO</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="index.php?hal=po"><i class="fa fa-circle-o"></i> Data PO</a></li>
            <li><a href="index.php?hal=spl"><i class="fa fa-plus"></i> Buat PO</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="glyphicon glyphicon-import"></i> <span>TTB</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="index.php?hal=ttb"><i class="fa fa-circle-o"></i> Data TTB</a></li>
            <li><a href="index.php?hal=po"><i class="fa fa-plus"></i> Buat TTB</a></li>
          </ul>
        </li>
        <li><a href="index.php?hal=si"><i class="glyphicon glyphicon-copy"></i> <span>Salinan Invoice</span></a></li>
